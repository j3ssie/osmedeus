...
"[project]/config/theme.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/theme-presets.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getPresetThemeStyles(name) {
    if (name === 'default') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultThemeState"];
    }
    ...
    return {
        light: {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultThemeState"].light,
            ...preset.light || {}
        },
        dark: {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultThemeState"].dark,
            ...preset.dark || {}
        },
        css: preset.css || {}
    };
...
"[project]/providers/color-vars-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildCss() {
    ...
    const preset = presetName ? __TURBOPACK__imported__module__$5b$project$5d2f$theme$2d$presets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["presets"][presetName] : undefined;
...
function ColorVarsProvider() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "ColorVarsProvider.useEffect": ()=>{
            const css = buildCss();
            if (css) applyCss(css);
            const handler = {
                "ColorVarsProvider.useEffect.handler": ()=>{
...
_s(ColorVarsProvider, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = ColorVarsProvider;
var _c;
__turbopack_context__.k.register(_c, "ColorVarsProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/lib/api/demo-mode.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isDemoMode() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_USE_MOCK === "true";
}
...
"[project]/lib/api/prefix.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function resolveBaseURL() {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$demo$2d$mode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDemoMode"])()) return "";
    if ("TURBOPACK compile-time truthy", 1) {
        const saved = localStorage.getItem("osmedeus_api_endpoint");
        if (saved) return saved.replace(/\/+$/, "");
    }
    const envUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.BASE_API_URL || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL;
...
http.interceptors.request.use((config)=>{
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$demo$2d$mode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDemoMode"])()) {
        ...
        if (typeof config.url === "string") {
            if (config.url === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$prefix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_PREFIX"]) {
                config.url = MOCK_API_PREFIX;
            } else if (config.url.startsWith(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$prefix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_PREFIX"]}/`)) {
                config.url = `${MOCK_API_PREFIX}${config.url.slice(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$prefix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_PREFIX"].length)}`;
            }
        }
    }
    if ("TURBOPACK compile-time truthy", 1) {
...
async function login(username, password) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$demo$2d$mode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDemoMode"])()) {
        const token = "mock-" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(username).toString("base64");
        return token;
    }
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["http"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$prefix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_PREFIX"]}/login`, {
        username,
        password
    });
...
function AuthProvider({ children }) {
    ...
    const DISABLE_AUTH = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== "undefined" && ("TURBOPACK compile-time value", "true") === "true";
    ...
    const login = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "AuthProvider.useCallback[login]": async (username, password)=>{
            const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(username, password);
...
_s(AuthProvider, "oUA75syCT+6uQ0D7AdekTlT/r+w=", false, function() {
    return [
...
//# sourceMappingURL=_5696dff5._.js.map